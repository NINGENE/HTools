...
#優先角度の確認いれる？
'''
angle = cmds.getAttr("LeftElbow.preferredAngleY")
print(angle)
if (angle == -45):
    print('H')
'''
...
def constAllJoints():
    ...
    #ALL_JOINT_01  = ('Root', 'hip_C', 'hair01_C', 'hair02_C', 'tail01_C', 'tail02_C') #墨兵のパターン
    ALL_JOINT_01  = ('Root', 'hip_C', 'spine01_C', 'spine02_C', 'head_C') #餓鬼のパターン
